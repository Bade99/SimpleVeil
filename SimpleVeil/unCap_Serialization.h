...
static str load_file_serialized(std::wstring folder = L"\\SimpleVeil", std::wstring filename = L"\\serialized.txt") {
...
static void save_to_file_serialized(str content, std::wstring folder = L"\\SimpleVeil", std::wstring filename = L"\\serialized.txt") {
	PWSTR general_folder;
